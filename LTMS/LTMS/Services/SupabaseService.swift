...
class SupabaseService {
    ...
    /// Fetch all published courses from all organizations
    ...
    func uploadVideo(
        ...
        let path = "\(organizationId)/\(courseId)/videos/\(fileName)"
    ...
    func uploadPDF(
        ...
        let path = "\(organizationId)/\(courseId)/pdfs/\(fileName)"
        return try await uploadFile(
            data: data,
    ...
    func uploadSlide(
        ...
        let path = "\(organizationId)/\(courseId)/slides/\(fileName)"
        return try await uploadFile(
            data: data,
    ...
    func uploadThumbnail(
        ...
        let path = "\(organizationId)/\(courseId)/\(fileName)"
        return try await uploadFile(
            data: data,
            bucket: StorageBuckets.courseThumbnails,
            path: path,
...
struct StorageBuckets {
    ...
    static let courseSlides = "Course Slides"
}

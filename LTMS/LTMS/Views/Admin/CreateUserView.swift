    ...
    private func createUser() {
        Task {
            ...
            do {
                ...
                // For testing mode
                if email.hasSuffix("@test.com") || email.hasSuffix("@ltms.test") {
                    try? await Task.sleep(nanoseconds: 500_000_000)
                    
                    // Create mock user and save to MockDataService
                    let mockUser = User(
                        id: UUID().uuidString,
                    ...
                    // Save to mock data service with password
                ...
                _ = try await SupabaseService.shared.create(user, in: FirebaseConstants.users)
